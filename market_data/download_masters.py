...
# XTS market data API credentials — from the environment (.env), see .env.example
API_KEY = env("XTS_MD_API_KEY")
API_SECRET = env("XTS_MD_API_SECRET")
SOURCE = env("XTS_MD_SOURCE", "WEBAPI")
BASE_URL = env("XTS_MD_REST_URL", "https://eztrade.wealthdiscovery.in/apimarketdata")
