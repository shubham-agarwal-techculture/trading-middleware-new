...
async def handle_signal(signal: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if action == "SELL":
            return "NOTICE: SELL signals are not yet send to the OMS. Only BUY and FLAT are processed. This is to prevent accidental shorting of options. Please use FLAT to square off existing positions."
